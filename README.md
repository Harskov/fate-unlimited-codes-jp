...
**160 of 5891** game functions are matched (0.42 % of the game code by size), and 1 game functions carry a name backed by evidence. 2343 SDK and runtime-library functions are identified as library code and are not counted.
