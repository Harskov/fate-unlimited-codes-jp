...
**41 of 5891** game functions are matched (0.09 % of the game code by size), and 0 game functions carry a name backed by evidence. 2343 SDK and runtime-library functions are identified as library code and are not counted.
