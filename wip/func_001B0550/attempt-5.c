...
s32 func_001B0550(s32 arg0, s32 arg1)
{
    ...
    if (arg1 & 0x82000)
        v |= 8;
    if (arg1 & 0x80)
        v |= D_00523918[arg0 + arg0 * 8];
    if (arg1 & 0x10)
        v |= D_0052391C[arg0 + arg0 * 8];
    if (arg1 & 0x20)
        v |= D_00523920[arg0 + arg0 * 8];
    if (arg1 & 0x40)
        v |= D_00523924[arg0 + arg0 * 8];
    if (arg1 & 4)
        v |= D_00523928[arg0 + arg0 * 8];
    if (arg1 & 1)
        v |= D_0052392C[arg0 + arg0 * 8];
    if (arg1 & 0x200)
        v |= D_00523930[arg0 + arg0 * 8];
    if (arg1 & 8)
        v |= D_00523934[arg0 + arg0 * 8];
    if (arg1 & 2)
        v |= D_00523938[arg0 + arg0 * 8];
    if (arg1 & 0x400)
        v |= D_0052393C[arg0 + arg0 * 8];
