...
u32 func_001B3B70(char *arg0)
{
    ...
    if (*(u32 *)(arg0 + 0x20) & 2) {
        ...
        m = 0xAAAAAAAB;
        sum = (u32)(((u64)m * ((b & 0xFF) + (c & 0xFF) + (d & 0xFF))) >> 32) >> 1;
        r0 = sum;
        sum = (u32)(((u64)m * (((b >> 8) & 0xFF) + ((c >> 8) & 0xFF) + ((d >> 8) & 0xFF))) >> 32) >> 1;
        r1 = sum;
        sum = (u32)(((u64)m * (((b >> 16) & 0xFF) + ((c >> 16) & 0xFF) + ((d >> 16) & 0xFF))) >> 32) >> 1;
        r2 = sum;
        sum = (u32)(((u64)m * (((b >> 24) & 0xFF) + ((c >> 24) & 0xFF) + ((d >> 24) & 0xFF))) >> 32) >> 1;
        r3 = sum;
    }
