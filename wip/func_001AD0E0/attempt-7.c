...
typedef struct Obj {
    int field_0;
    unsigned char pad2[0x1F4];
    int field_1F8;
    unsigned char pad3[0x1A8];
    int field_23A4;
    unsigned char pad4[0x4];
    int field_23AC;
    unsigned char pad5[0x24];
    int field_23D4;
} Obj;
...
void func_001AD0E0(Obj *arg0, int arg1, int arg2, int arg3)
{
    ...
    if (arg1 < end) {
        ...
        do {
            ...
            if (m != 0) {
                do {
                    if (!(arg3 & 2) || arg0 != m->field_0) {
                        *(int *)((char *)m + arg0->field_0 * 4 + 0x23AC) = arg2;
                        *(int *)((char *)m + 0x23A4) = arg3;
                    }
                    m = m->field_C;
                } while (m != 0);
            }
