...
typedef struct Obj {
    ...
    int field_1F8;
    unsigned char pad2[0x23A4 - 0x1F8 - 4];
    int field_23A4;
    unsigned char pad3[0x23AC - 0x23A4 - 4];
    int field_23AC;
    unsigned char pad4[0x23D4 - 0x23AC - 4];
    int field_23D4;
} Obj;
...
void func_001AD0E0(Obj *arg0, int arg1, int arg2, int arg3)
{
    ...
    if (arg1 < end) {
        ...
        do {
            ...
            if (n->field_C != 0) {
                do {
                    if (!(arg3 & 2) || arg0 != n->field_C->field_8) {
                        *(int *)((char *)n->field_C + arg0->field_8 * 4 + 0x23AC) = arg2;
