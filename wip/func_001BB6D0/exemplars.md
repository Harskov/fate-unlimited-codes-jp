# Exemplars for func_001BB6D0 — the 3 matched functions nearest by address

## func_001BB690 @ 0x001BB690 (score 100.0, mwcps2-3.0.1b151-050317 -O4,p)

```c
typedef int s32;

s32 func_001BB690(char *arg0)
{
    s32 *p;
    s32 v;
