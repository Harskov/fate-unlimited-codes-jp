# Friction Report — 2026-09-18-011-consolidate

**Job folder:** `2026-09-18-011-consolidate`  
**Log:** `friction-log.jsonl` (1 entry; opened 2026-09-18T20:32:29Z, exported 2026-09-18T20:44:45Z)  
**Skills build:** mwcps2-3.0.1b151-050317 / wibo / objdiff-cli  
**Severity counts:** papercut 1  
...
- **Stage:** Stage E EXECUTE | **Function:** `func_001A3800` | **Tool:** `knowledge/K1-ps2-mwcc-matching-primer.md` | **Logged:** 2026-09-18T20:38:14Z
- **Observed (fact):** Wrote the struct-with-array-member-at-0xE8 view (D_0051D890.list[i].unk_0) and ran match.py try func_001A3800: 98.6, rows 'lui %hi(D_0051D890+0xe8)' vs 'lui %hi(D_0051D890)' and 'sw a1, 0x0(v1)' vs 'sw a1, 0xe8(v1)'. K1 6.9 already records 'D_x.slots[i].unk_0 (slots at +0xE8) folds and scores 98.6' from remediation 7, same function.
- **Expected:** K1 6.9 read fully before the first attempt; the documented byte-identical form (element pointer then constant step) written directly.
- **Operator hypothesis — UNVERIFIED, verify against the artifacts before building on it:** K1 6.9 is long and the negative results sit in the middle of the paragraph; the step procedure points at 6.9 for the rewrite but not at the fact that the alternatives are already scored there.
- **Repro:** `python3 skills/dps2-toolkit/scripts/match.py --repo targets/fate-unlimited-codes-jp try func_001A3800 src/game_00/func_001A3800.c`
...
```json
{
  "job": "2026-09-18-011-consolidate",
  "exported": "2026-09-18T20:44:45Z",
  "build": "mwcps2-3.0.1b151-050317 / wibo / objdiff-cli",
  "entry_count": 1,
  "severity_counts": {
    "papercut": 1
  },
  ...
  "entries": [
    {
      ...
      "title": "re-ran a spelling K1 6.9 already scored",
